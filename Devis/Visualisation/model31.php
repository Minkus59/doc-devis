...
if ($this->type=="1") {
    ...
    $this->SetXY( 150 , 85 );
    $this->SetFont( $this->Typo, "B", $this->TailleText);
    $this->Cell(50,$this->Width, "Date d'échéance", 1, 0, "C",1);
    ...
    if (!empty($this->numtva)) {
        ...
        $this->SetFont( $this->Typo, "B", $this->TailleText);
        $this->SetXY( 10 , 85 );
        $this->Cell(50, $this->Width, "TVA Intracommunautaire", 1, 0, "C",1);
 ...
 // tableau central
    ...
    $this->SetXY( 100 , 100 );
    $this->MultiCell(15, 5, "Total boite", 1, "C",1);

    $this->SetXY( 115 , 100 );
    $this->MultiCell(15, 10, "Quantité", 1, "C",1);

    $this->SetXY( 130 , 100 );
    $this->MultiCell(15, 3.3, "Poid brut (KG)", 1, "C",1);

    $this->SetXY( 145 , 100 );
    $this->MultiCell(15, 5, "Poid net (KG)", 1, "C", 1);

    $this->SetXY( 160 , 100 );
    $this->MultiCell(20, 10, "PU HT", 1, "C", 1);

    $this->SetXY( 180 , 100 );
    $this->MultiCell(20, 10, "Total HT", 1, "C", 1);
}
...
function Bas() {
  ...
  $this->Cell(35, $this->Width, "Ce produits textiles sont des lots d'actions de la surproduction chinoise . Idéal trading est pas responsable de la qualité de ces produits textiles", 0, 0, "L");
...
if ($this->AcompteActif!=0) {
    $this->SetX( 130  );
    $this->Cell(35, $this->Width, "Acompte", 1, 0, "C",1);
}
...
if ($this->AE=="1") {
  ...
  $this->Cell(105, $this->Width, "TVA non applicable, art.293-B du CGI", 0, 0, "R");
    ...
    $this->SetX( 130  );
    $this->Cell(35, $this->Width, "Service de livraison payé", 1, 0, "C",1);
    ...
    $this->SetX( 130  );
    $this->Cell(35, $this->Width, "Total des boîtes", 1, 0, "C",1);
    ...
    $this->SetX( 130  );
    $this->Cell(35, $this->Width, "Poids brut (KG)", 1, 0, "C",1);
    ...
    $this->SetX( 130  );
    $this->Cell(35, $this->Width, "Poids net (KG)", 1, 0, "C",1);
    ...
    $this->SetX( 130  );
    $this->Cell(35, $this->Width, "Conteneur N °", 1, 0, "C",1);
    ...
    $this->SetX( 130  );
    $this->Cell(35, $this->Width, "Produit d'origine", 1, 0, "C",1);
