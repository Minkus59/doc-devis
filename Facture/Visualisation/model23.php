...
function setDdp($New_Indice35){
     $this->Ddp = $New_Indice35;
}
function setTb($New_Indice36){
     $this->Tb = $New_Indice36;
}
function setTp($New_Indice37){
     $this->Tp = $New_Indice37;
}
function setGw($New_Indice38){
     $this->Gw = $New_Indice38;
}
function setNw($New_Indice39){
     $this->Nw = $New_Indice39;
}
function setCn($New_Indice40){
     $this->Cn = $New_Indice40;
}
function setOp($New_Indice41){
     $this->Op = $New_Indice41;
}
function setTaux($New_Indice42){
     $this->Taux = $New_Indice42;
}
...
//Cadre Haut droite
    ...
    $this->SetX( 110 );
    $this->SetFont( $this->Typo, "B", $this->TailleText);
    $this->Cell(30, $this->Width, "N° Bill", 1, 0, "C",1);
...
function Bas() {
  $this->SetX( 10 );
    ...
    $this->Cell(190, 5, "Retention of ( the law 12/05/1980 ) , the goods remain our property until full payment", 0, 0, "L");
    $this->Ln();
    $this->Cell(190, 4, "Late penalties at the rate of : ".$this->Penalite." % - Discount for early payment : ".$this->Escompte, 0, 0, "L");
    $this->Ln();
    $this->Cell(190, 4, "Delay of paimement : ".$this->Delai, 0, 0, "L");
    $this->Ln();
    ...
    $this->SetX( 130  );
    $this->Cell(40, $this->Width, "Total excl tax :", 0, 0, "R");
    ...
    $this->SetTextColor($this->ColorText2);
    $this->SetX( 130  );
    $this->Cell(40, $this->Width, "Net pay :", 0, 0, "R");
    ...
    if ($this->AcompteActif!=0) {
        ...
        $this->SetTextColor($this->ColorText2);
        $this->SetX( 130  );
        $this->Cell(40, $this->Width, "Deposit :", 0, 0, "R");
    ...
    $this->SetX( 95 );
    $this->SetFont( $this->Typo, "", $this->TailleText-3);
    $this->Cell(95, $this->Width, "VAT not applicable , art.293 - B CGI", 0, 0, "R");
    } 
